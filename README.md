# Project description
The scope of the project is to analyze the correlations among Fear and Greed Index, Bitcoin Price, and the S&P Cryptocurrency Broad Digital Asset (BDA) Index. In particular, The Fear and Greed Index measures crypto market sentiment. The BDA Index is the cryptocurrency market benchmark index. This benchmark index is designed to track the performance of a wide range of investable digital assets that meet specific liquidity and market capitalization criteria. 
